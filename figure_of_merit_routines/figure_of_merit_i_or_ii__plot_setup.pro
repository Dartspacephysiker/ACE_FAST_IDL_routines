...
FUNCTION FIGURE_OF_MERIT_I_OR_II__PLOT_SETUP, $
  ...
  CASE fom_type OF
     1: BEGIN
        inFile_north                       = h2dFileDir+'processed/'+fileDia+'--Cusp_splitting--NORTH_figures_of_merit_I--delays_0-30min.sav'
        IF KEYWORD_SET(use_old_south) THEN BEGIN
        ...
        ENDIF ELSE BEGIN
           inFile_south                    = h2dFileDir+'processed/'+fileDia+'--Cusp_splitting--SOUTH_figures_of_merit_I--delays_0-30min.sav'
        ENDELSE
