  ...
  FOR iList=0,N_ELEMENTS(h2dStrArr_list)-1 DO BEGIN
     ...
     IF ~KEYWORD_SET(PASIS__alfDB_plot_struct.justData) THEN BEGIN
        ...
        PLOT_ALFVENDB_2DHISTOS, $
           ...
           NO_COLORBAR=no_colorbar, $
           EPS_OUTPUT=eps_output, $
           PLOTH2D_CONTOUR=TAG_EXIST(PASIS__alfDB_plot_struct,'plotH2D_contour') ? PASIS__alfDB_plot_struct.plotH2D_contour : !NULL, $
           CONTOUR__LEVELS=TAG_EXIST(PASIS__alfDB_plot_struct,'contour__levels') ? PASIS__alfDB_plot_struct.contour__levels : !NULL, $
           CONTOUR__PERCENT=TAG_EXIST(PASIS__alfDB_plot_struct,'contour__percent') ? PASIS__alfDB_plot_struct.contour__percent : !NULL, $
           PLOTH2D__KERNEL_DENSITY_UNMASK=TAG_EXIST(PASIS__alfDB_plot_struct,'plotH2D__kernel_density_unmask') ? PASIS__alfDB_plot_struct.plotH2D__kernel_density_unmask : !NULL, $
