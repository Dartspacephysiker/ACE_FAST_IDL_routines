...
cghistoplot,lShell(largeStorm_ind),/OPROBABILITY, $
            BINSIZE=binSize_lShell,OUTPUT='L-SHELL--histogram_and_cdf--large_storms--HEAVILY_PARED--1996-10-23_through_2000-10-05.png', $
            CHARSIZE=2.5,THICK=2.0
;Southern
cghistoplot,lShell,MAXINPUT=xRange_lShell[1],MININPUT=xRange_lShell[0], $
            /OPROBABILITY, $    ;Southern hemi
            BINSIZE=binSize_lShell,OUTPUT='L-SHELL--Southern--histogram_and_cdf--large_storms--HEAVILY_PARED--1996-10-23_through_2000-10-05.png'
...
cghistoplot,ABS(lShell(cgsetintersection(largestorm_ind,where(maximus.ilat LT 0)))),MAXINPUT=xRange_lShell[1],MININPUT=xRange_lShell[0], $
            /OPROBABILITY, $    ;Southern hemi
            BINSIZE=binSize_lShell,OUTPUT='L-SHELL--Southern--reversed--histogram_and_cdf--large_storms--HEAVILY_PARED--1996-10-23_through_2000-10-05.png'
...
cghistoplot,lShell(cgsetintersection(largestorm_ind,where(maximus.ilat GT 0))),MAXINPUT=xRange_lShell[1],MININPUT=xRange_lShell[0], $
            ...
            BINSIZE=binSize_lShell,OUTPUT='L-SHELL--Northern--histogram_and_cdf--large_storms--HEAVILY_PARED--1996-10-23_through_2000-10-05.png'

;**************************************************
;ILAT

cghistoplot,maximus.ilat(largeStorm_ind),/OPROBABILITY, $
            BINSIZE=binSize_ILAT,OUTPUT='ILAT--histogram_and_cdf--large_storms--HEAVILY_PARED--1996-10-23_through_2000-10-05.png',CHARSIZE=2.5,THICK=2.0
;Southern
cghistoplot,maximus.ilat,MAXINPUT=-xRange_ILAT[0],MININPUT=-xRange_ILAT[1],/OPROBABILITY, $   ;Southern hemi
            BINSIZE=binSize_ILAT,OUTPUT='ILAT--Southern--histogram_and_cdf--large_storms--HEAVILY_PARED--1996-10-23_through_2000-10-05.png'
...
cghistoplot,ABS(maximus.ilat(cgsetintersection(largestorm_ind,where(maximus.ilat LT 0)))),MAXINPUT=xRange_ILAT[1],MININPUT=xRange_ILAT[0], $
            /OPROBABILITY, $    ;Southern hemi
            BINSIZE=binSize_ILAT,OUTPUT='ILAT--Southern--reversed--histogram_and_cdf--large_storms--HEAVILY_PARED--1996-10-23_through_2000-10-05.png'
...
cghistoplot,maximus.ilat(cgsetintersection(largestorm_ind,where(maximus.ilat GT 0))), $
            ...
            /OPROBABILITY, $    ;Northern
            BINSIZE=binSize_ILAT,OUTPUT='ILAT--Northern--histogram_and_cdf--large_storms--HEAVILY_PARED--1996-10-23_through_2000-10-05.png'

;**************************************************
;MLT
cghistoplot,maximus.mlt(largestorm_ind), $                                            ;South
            /OPROBABILITY,BINSIZE=binSize_MLT,OUTPUT='MLT--histogram_and_cdf--large_storms--HEAVILY_PARED--1996-10-23_through_2000-10-05.png'
cghistoplot,maximus.mlt(cgsetintersection(largestorm_ind,where(maximus.ilat GT 0))), $ ;South
            /OPROBABILITY,BINSIZE=binSize_MLT,OUTPUT='MLT--Northern--histogram_and_cdf--large_storms--HEAVILY_PARED--1996-10-23_through_2000-10-05.png'
cghistoplot,maximus.mlt(cgsetintersection(largestorm_ind,where(maximus.ilat LT 0))), $ ;North
            /OPROBABILITY,BINSIZE=binSize_MLT,OUTPUT='MLT--Southern--histogram_and_cdf--large_storms--HEAVILY_PARED--1996-10-23_through_2000-10-05.png'
...
xRange=xRange_MLT
xTitle='MLT'
outFile='MLT--largeStorms--HEAVILY_PARED--overlaid_w_all_events.png'
...
outFile='MLT--Northern--largeStorms--HEAVILY_PARED--overlaid_w_all_events.png'
...
outFile='MLT--Southern--largeStorms--HEAVILY_PARED--overlaid_w_all_events.png'
OVERLAY_TWO_HISTOS,data_1,data_2,DATA_1_COL=data_1_col,DATA_2_COL=data_2_col, $
                   DATA_1_TITLE=data_1_title,DATA_2_TITLE=data_2_title, $
                   BINSIZE=binSize,XRANGE=xRange,YRANGE=yRange,HISTTITLE=histTitle,XTITLE=xTitle, $
                   OUTFILE=outFile,POS=pos
...
xTitle='L-SHELL'
outFile='L-SHELL--largeStorms--HEAVILY_PARED--overlaid_w_all_events.png'
...
outFile='L-SHELL--Northern--largeStorms--HEAVILY_PARED--overlaid_w_all_events.png'
...
outFile='L-SHELL--Southern--largeStorms--HEAVILY_PARED--overlaid_w_all_events.png'
OVERLAY_TWO_HISTOS,data_1,data_2,DATA_1_COL=data_1_col,DATA_2_COL=data_2_col, $
                   DATA_1_TITLE=data_1_title,DATA_2_TITLE=data_2_title, $
                   BINSIZE=binSize,XRANGE=xRange,YRANGE=yRange,HISTTITLE=histTitle,XTITLE=xTitle, $
                   OUTFILE=outFile,POS=pos
...
yRange=yRange_MLT_ILAT
xTitle='ILAT'
outFile='ILAT--largeStorms--HEAVILY_PARED--overlaid_w_all_events.png'
...
outFile='ILAT--Northern--largeStorms--HEAVILY_PARED--overlaid_w_all_events.png'
