...
plot_alfven_stats_imf_screening,CLOCKSTR="bzNorth",altituderange=[1000,5000],charerange=[4,300],BZMIN=3,BYMIN=0,/NEVENTPERMINPLOT, $
                                SMOOTHWINDOW=5,/del_ps,/NOPLOTINTEGRAL 

plot_alfven_stats_imf_screening,CLOCKSTR="bzSouth",altituderange=[1000,5000],charerange=[4,300],BZMIN=3,BYMIN=0,/NEVENTPERMINPLOT,$
                                SMOOTHWINDOW=5,/del_ps,/NOPLOTINTEGRAL
