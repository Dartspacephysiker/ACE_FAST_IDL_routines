...
warped = cgWarpToMap(temp,this,that, MAP=mapNorth, $
                      Resolution=[100,100],/SETRANGE)
dswarped = cgWarpToMap(newtemp,this,that, MAP=mapNorth, $
                      Resolution=[100,100],/SETRANGE)
...
cgImage, warped, Position=[0.1,0.1,0.8,0.8],stretch=1,bottom=1,top=BYTE(nLevels-2),negative=0
mapNorth -> Draw
