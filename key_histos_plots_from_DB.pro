...
;;        print,format='(A0,T20,A0)',maxTags(maxStructInd(i)),maxTags(tempStructInd(j))
        ...
        curPlot = scatterplot(maximus.(mS_j),maximus.(mS_i), $
                    SYMBOL="o",SYM_TRANSPARENCY=99,SYM_SIZE=0.5, $ ;This is necessary. There is such a high density of points that we need transparency
     ...
     cghistoplot,maximus.(mS_i),TITLE=maxTags(mS_i), $
                 ...
                 OUTFILENAME=maxTags(mS_i)+"_histogram"+plotSuff+".png"
