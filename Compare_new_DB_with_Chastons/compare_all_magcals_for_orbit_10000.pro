...
;for infile
datadir='/SPENCEdata/software/sdt/batch_jobs/Alfven_study/as5_14F/magcal_versions/output/'
...
FOR i=0,N_ELEMENTS(versarr)-1 DO BEGIN & $
  ...
  ;print,curf & $
  ;print,outf & $
  compare_chastondbfile_dartdbfile_3,10000,interval=interv,max_tdiff=0.016,fname=curf,outdataf=outf,outname=oname,/only_alfvenic & $
ENDFOR