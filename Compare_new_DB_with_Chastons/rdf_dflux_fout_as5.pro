...
print,test,"total_electron_energy_dflux_single_interval",string(total_electron_energy_dflux_single_interval)
readf,f_unit,format='(A60,G16.6)',test,total_electron_energy_dflux_all_intervals
print,test,"total_electron_energy_dflux_all_intervals: ", string(total_electron_energy_dflux_all_intervals)
readf,f_unit,format='(A43,G16.6)',test,total_alfven_electron_energy_dflux
print,test,"total_alfven_electron_energy_dflux: ", string(total_alfven_electron_energy_dflux)
readf,f_unit,format='(A51,G16.6)',test,total_ion_outflow_single_interval
print,test,"total_ion_outflow_single_interval",string(total_ion_outflow_single_interval)
readf,f_unit,format='(A57,G16.6)',test,total_ion_outflow_all_intervals
print,test,"total_ion_outflow_all_intervals",string(total_ion_outflow_all_intervals)
readf,f_unit,format='(A40,G16.6)',test,total_alfven_ion_outflow
print,test,"total_alfven_ion_outflow",string(total_alfven_ion_outflow)
readf,f_unit,format='(A64,G16.6)',test,total_upward_ion_outflow_single_interval
print,test,"total_upward_ion_outflow_single_interval",string(total_upward_ion_outflow_single_interval)
...
print,test,"total_alfven_upward_ion_outflow",string(total_alfven_upward_ion_outflow)
free_lun,f_unit
