...
;
;-
PRO PLOT_FIGURE_OF_MERIT_I_OR_II__DAWN_AND_DUSK_CELL_IN_NORTHERN_AND_SOUTHERN_HEMI__SINGLE_WINDOW, $
   HEMI=hemi, $
  ...
  IF KEYWORD_SET(savePlots) THEN BEGIN
     ...
     spName                         = STRING(FORMAT=spNFmt,GET_TODAY_STRING(/DO_YYYYMMDD_FMT),fom_type, $
                                             'DAWN_AND_DUSK'+(KEYWORD_SET(use_old_south) ? '--oldSouth' : ''),plotExt) 
     ;; ENDIF
