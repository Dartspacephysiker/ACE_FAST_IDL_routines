PRO JOURNAL__20160627__SHOW_ME_THE_IMF_FOR_BZ_NORTH_BIG_PFLUX__ORB_10837
  
  orbStr                   = '10837'
  savePlot                 = 1
  savePName                = GET_TODAY_STRING(/DO_YYYYMMDD_FMT) + $
                             '--SW_conditions_for_bzNorth--orb'+orbStr+'.png'

  use_dartDB__bef_nov1999  = 1
  geomag_axis_style        = 3

  tStartString             = '1999-05-18/17:45:45.235'
  ...
  OMNI_quantities_to_plot  = 'by_gse,bz_gse,bx_gse,flow_speed,sym_h'
  omni_quantity_ranges     = [[-12,12],[-12,12],[-12,12],[500,650],[-20,0]]
  omni_quantity_axis_style = [3,3,3,1,1]
