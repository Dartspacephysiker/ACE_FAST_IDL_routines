...
PRO JOURNAL__20160322__CROSS_CORRELATE_CONJUGATE_CELLS_IN_EACH_HEMISPHERE
  ...
  duskward_alfvenic_list   = LIST(smoothNEvList_hemis[0,2],smoothNEvList_hemis[1,3])
  duskward_particle_list   = LIST(smoothNEvList_hemis[0,3],smoothNEvList_hemis[1,2])
  ...
  duskward_alfvenic_titles = [title_list_hemis[0,2],title_list_hemis[1,3]]
  duskward_particle_titles = [title_list_hemis[0,3],title_list_hemis[1,2]]
  ...
  outPlot = "journal__20160322--DAWNWARD_IMF--Alfvenic_and_particle--"+smoothStr $
  ...
  SET_PLOT_DIR,plotDir,/FOR_SW_IMF,/ADD_TODAY
  outPlot = "journal__20160322--DUSKWARD_IMF--Alfvenic_and_particle--"+smoothStr $
            + "--n_delays__" + STRCOMPRESS(nDelays,/REMOVE_ALL)+"--" + omni_paramStr+'.png'
  PRINT,'saving ' + outPlot
  window.save,plotDir+outPlot
  ...
  dawnward_particle_ccor = C_CORRELATE(dawnward_particle_list[0],dawnward_particle_list[1],lags)
     ...
     outPlot_CC="journal__20160322--DAWNWARD_IMF--Alfvenic_and_particle_hemi_CrossCor--" + smoothStr $
                + "--n_delays__" + STRCOMPRESS(nDelays,/REMOVE_ALL)+"--" + omni_paramStr + '.png'
  ...
  duskward_particle_ccor = C_CORRELATE(duskward_particle_list[0],duskward_particle_list[1],lags)
     ...
     outPlot_CC="journal__20160322--DUSKWARD_IMF--Alfvenic_and_particle_hemi_CrossCor--" + smoothStr $
                + "--n_delays__" + STRCOMPRESS(nDelays,/REMOVE_ALL)+"--" + omni_paramStr + '.png'
     PRINT,'saving ' + outPlot_CC
     window_cc.save,plotDir+outPlot_CC
