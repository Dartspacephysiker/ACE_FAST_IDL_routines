...
PRO JOURNAL__20160216__FIGURE_OF_MERIT_III_IV_V_FOR_CUSP_SPLITTING__NORTH_OR_SOUTH__NONSTORM, $
   HEMI=hemi, $
   FOMSTRING=FOMString, $
  ...
  @journal__20160216__figure_of_merit_defaults__nonstorm
  ...
  h2dFNameFmt                              = '("raw/polarplots_"' + $
     ...
     ',F0.2,"mindelay_byMin",F3.1,"--non-storm.dat")'
