;2016/05/05 Just to beef the statistics, loosen up magc
...
PRO JOURNAL__20160505__PLOT_NEVENTS_W_PFLUX_GE_5MW_PER_M2_FOR_ALT_SLICES__ORG_BY_IMF_BY__LOOSEN_MAGC_REQ
  ...
  FOR i=0,N_ELEMENTS(altRange[0,*])-1 DO BEGIN
     ...
     altStr        = STRING(FORMAT='("--",I0,"-",I0,"km--ABSmagc_GE_",I0,"--pFlux_GE_",I0)', $
                            altitudeRange[0], $
                            altitudeRange[1], $
                            minMC, $
                            pFluxMin)
     ;; tilePlotTitle = STRING(FORMAT='(I0,"-",I0," km, Poynting flux $\geq$ ",I0," mW m!U-2!N")',altitudeRange[0],altitudeRange[1],pFluxMin)
     tilePlotTitle = STRING(FORMAT='(I0,"-",I0," km, magc GE ",I0,", pFlux GE ",I0)', $
                            altitudeRange[0], $
                            altitudeRange[1], $
                            minMC, $
                            pFluxMin)
