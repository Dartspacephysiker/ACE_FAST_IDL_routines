;;2017/08/17
PRO JOURNAL__20170817__LOOK_AT_NEWELLINTERP_FOR_ALFS_IN_CUSP

  COMPILE_OPT IDL2,STRICTARRSUBS

  @common__maximus_vars.pro

  ;;This file is made by JOURNAL__20170209__ALIGN_ALFDB_WITH_CLOSEST_ESPEC_DB_TO_GET_PRECIP_TYPE
  inDir         = '/SPENCEdata/Research/database/FAST/dartdb/saves/'
  inFile        = 'Dartdb_20151222--500-16361_inc_lower_lats--max_magCurrent_time_alfs_into_20160607_eSpecDB__good_i.sav'
  inFile        = inDir + inFile
  ...
  IF KEYWORD_SET(make_file) THEN BEGIN
     ...
     justGood = MAKE_NEWELL_IDENT_STRUCT_FOR_ALFDB__FROM_FILE(!NULL,!NULL,!NULL, $
                                                              inFile, $
                                                              /USE_COMMON_VARS, $
                                                              USER_INDS=good_i, $
                                                              /DONT_MAP_TO_100KM);, $
  ...
  PRINT,'************'
  PRINT,FORMAT='("highCE in ",A0,": ",I0," (",F0.2,A0,")")',restStr,nNoonHighCE,FLOAT(nNoonHighCE)/nGNooner*100.,"%"
  PRINT,FORMAT='("lowCE  in ",A0,": ",I0," (",F0.2,A0,")")',restStr,nNoonLowCE,FLOAT(nNoonLowCE)/nGNooner*100.,"%"
  PRINT,"Tot           : ",nNoonHighCE+nNoonLowCE
  PRINT,''
  PRINT,'************'
  PRINT,FORMAT='("highCEGE10 in ",A0,": ",I0," (",F0.2,A0,")")',restStr,nNoonHighCEGE10,FLOAT(nNoonHighCEGE10)/nNoonMagCGE10*100.,"%"
  PRINT,FORMAT='("lowCEGE10  in ",A0,": ",I0," (",F0.2,A0,")")',restStr,nNoonLowCEGE10,FLOAT(nNoonLowCEGE10)/nNoonMagCGE10*100.,"%"
