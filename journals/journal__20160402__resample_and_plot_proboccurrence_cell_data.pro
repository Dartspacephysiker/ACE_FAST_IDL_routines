...
PRO JOURNAL__20160402__RESAMPLE_AND_PLOT_PROBOCCURRENCE_CELL_DATA
  ...
  ;; omniParamStr      = '--OMNI_params--duskward--negAngle_45__posAngle_135--ABS_byMin_10.00--bzMax_2.00.sav'
  ;; omniParamStr      = '--OMNI_params--duskward--negAngle_60__posAngle_120--ABS_byMin_10.00--bzMax_2.00.sav'
  omniParamStr      = '--OMNI_params--duskward--negAngle_60__posAngle_120--ABS_byMin_10.00--bzMax_0.00.sav'
  ;; omniParamStr      = '--OMNI_params--bzSouth--negAngle_120__posAngle_-120--ABS_byMax_4.00--ABS_bzMin_8.00.sav'

  date                           = '20160403'

  crossCorrStr                 = 'journal__' + date + '__CrossCorr_probOccurrence_vs_delay--all_alts--'
  plotPrefStr                  = 'journal__' + date + '__plot_probOccurrence_vs_delay--all_alts--'
  ...
  inDir                  = '/SPENCEdata/Research/Satellites/FAST/OMNI_FAST/journals/journal__' + date + '__probOccurrence_and_crosscorrelation_savefiles/'
