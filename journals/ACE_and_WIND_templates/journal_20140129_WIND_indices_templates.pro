...
;CD, '/SPENCEdata/Research/database/magdata'
  
;WIND_magdata_tmplt= ascii_template()
...
;mag_prop=read_ascii("windmagP_199611-199904.dat",template=WIND_magdata_tmplt)
;save,/variables,filename="idl_winddata.dat"
