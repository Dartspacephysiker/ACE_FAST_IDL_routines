;;2016/02/13
;;Fancify
PRO JOURNAL__20160216__FIGURE_OF_MERIT_III_IV_V__CALC_AND_PLOT_DAWN_DUSK_OR_COMBINED_CELL_IN_NORTHERN_AND_SOUTHERN_HEMI__SINGLE_WINDOW__NONSTORM
  ...
  FOR i=0,N_ELEMENTS(fom_type)-1 DO BEGIN
     FOR j=0,N_ELEMENTS(hemiStrings)-1 DO BEGIN
        JOURNAL__20160216__FIGURE_OF_MERIT_III_IV_V_FOR_CUSP_SPLITTING__NORTH_OR_SOUTH__NONSTORM, $
           HEMI=hemiStrings[j], $
