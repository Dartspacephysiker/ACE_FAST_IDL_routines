;2016/03/28 Check it
PRO JOURNAL__20160328__CROSS_CORRELATE_CONJUGATE_CELLS_IN_EACH_HEMISPHERE
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ;;DAWNWARD IMF STUFF
  WINDOW_CUSTOM_SETUP,NPLOTCOLUMNS=N_ELEMENTS(cell)-KEYWORD_SET(do_center_cell), $
  ...
  outPlot = "journal__20160328--DAWNWARD_IMF--Alfvenic_and_particle--"+smoothStr $
  ...
  SET_PLOT_DIR,plotDir,/FOR_SW_IMF,/ADD_TODAY
  outPlot = "journal__20160328--DUSKWARD_IMF--Alfvenic_and_particle--"+smoothStr + delayStr + omni_paramStr+'.png'
  PRINT,'saving ' + outPlot
  window.save,plotDir+outPlot
  ...
  dawnward_particle_ccor = C_CORRELATE(dawnward_particle_list[0],dawnward_particle_list[1],lags)
     ...
     outPlot_CC="journal__20160328--DAWNWARD_IMF--Alfvenic_and_particle_hemi_CrossCor--" + smoothStr $
                + "--n_delays__" + STRCOMPRESS(nDelays,/REMOVE_ALL)+"--" + omni_paramStr + '.png'
  ...
  duskward_particle_ccor = C_CORRELATE(duskward_particle_list[0],duskward_particle_list[1],lags)
     ...
     outPlot_CC="journal__20160328--DUSKWARD_IMF--Alfvenic_and_particle_hemi_CrossCor--" + smoothStr + delayStr + omni_paramStr + '.png'
     PRINT,'saving ' + outPlot_CC
     window_cc.save,plotDir+outPlot_CC
