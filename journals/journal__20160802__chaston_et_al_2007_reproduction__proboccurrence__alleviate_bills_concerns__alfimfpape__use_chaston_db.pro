...
PRO JOURNAL__20160802__CHASTON_ET_AL_2007_REPRODUCTION__PROBOCCURRENCE__ALLEVIATE_BILLS_CONCERNS__ALFIMFPAPE__USE_CHASTON_DB
  ...
  orbContrib__reference_alfvenDB = 0
  nowepco_range                  = KEYWORD_SET(orbContrib__reference_alfvenDB) ? $
                                   [0.0,1.0] : $
                                   [0.0,0.33]
  nowepco_autoscale              = 0
  ...
  ;; orbRange                       = [1000,10000]
  orbRange                       = [100:999]*10
  orbRange                       = [orbRange,orbRange+5,orbRange+7,10000]
  orbRange                       = orbRange[SORT(orbRange)]
