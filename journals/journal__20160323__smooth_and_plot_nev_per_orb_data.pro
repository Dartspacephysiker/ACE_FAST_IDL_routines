...
PRO JOURNAL__20160323__SMOOTH_AND_PLOT_NEV_PER_ORB_DATA
  ...
  omniParamStr      = 'OMNI_params--duskward--negAngle_135__posAngle_-135--ABS_byMin_5.00--bzMax_-1.00.sav'
  ...
  outPlot = "journal__20160323__plot_nev_per_orb_vs_delay--"+smoothStr $
  ...
  duskward_ccor = C_CORRELATE(smoothedNEvList[2+KEYWORD_SET(do_center_cell)],smoothedNEvList[3+KEYWORD_SET(do_center_cell)],lags)
     ...
     outPlot_CC="journal__20160323__CrossCorr_nev_per_orb_vs_delay--" + smoothStr $
                + hemi + "--n_delays__" + STRCOMPRESS(nDelays,/REMOVE_ALL)+"--" + omni_paramStr + '.png'
