...
FUNCTION GET_RESTRICTED_AND_INTERPED_DB_INDICES,dbStruct,satellite,delay,LUN=lun, $
  ...
  IF KEYWORD_SET(for_eSpec_or_ion_db) THEN BEGIN
     ...
     ;;YOU'RE RIGHT HERE. YOU HAVEN'T TESTED THIS IF STATEMENT YET, OR FOR THIS ROUTINE.
     ;;YOU ALSO HAVEN'T YET ATTEMPTED TO GET NONALFVEN_FLUXES ANYWHERE WITHIN PLOT_ALFVEN_STATS_IMF_SCREENING
